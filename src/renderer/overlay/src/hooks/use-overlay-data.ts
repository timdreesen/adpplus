...
export function useOverlayData(): OverlayState & {
  ...
  const resetOverlay = (): void => {
    ...
    setOverlayData((prev) => prev ? { ...prev, scanData: null, opCombinations: [], trapCombinations: [], heroSynergies: [], heroTraps: [], heroModels: [], heroesForMySpotUI: [], topHeroesByWinrate: [], topSpellsByWinrate: [], pickedAbilityDisplayNames: [] } : null)
  }
